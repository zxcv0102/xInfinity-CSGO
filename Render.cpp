...
void Render::SetupFonts()
{
	...
	font.MenuBold = g_Surface->FontCreate();
	...
	g_Surface->SetFontGlyphSet(font.MenuBold, "Code Bold", 14, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.Guns, "Code Bold", 14, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.DroppedGuns, "Code Bold", 14, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
...
void Render::DrawRect2(int x1, int y1, int x2, int y2, Color clr)
{
...
{
	const matrix3x4_t& worldToScreen = g_Engine->WorldToScreenMatrix(); //Grab the world to screen matrix from CEngineClient::WorldToScreenMatrix
