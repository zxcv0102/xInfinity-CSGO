...
char* const tuxlist[] =
{
    "Shaxzyware owns me and all",
    "Your cheat can suck my powerful Shaxzyware",
    "It's free as in FREEDOM!",
    "Shaxzyware only let me out so I could play this game, please be nice!",
    "Shaxzyware nutted but you keep sucken",
    "Shaxzyware > All",
};
...
{
    "You just got rekt by xInfinity",
    "Git Gud! Git xInfinity!",
    "I'm not cheating, but If I was I would recommend xInfinity",
    "xInfinity > all",
    "You think your ayypaste is better than xInfinity?",
    "Stop being a noob nigger, git xInfinity"
};
