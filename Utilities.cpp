...
DWORD U::FindPattern3(PCHAR pPattern, DWORD dwStart, DWORD dwEnd, DWORD dwOffset)
{
...
DWORD U::FindPattern3(PCHAR szModule, PCHAR pPattern, DWORD dwOffset)
{
	...
	return FindPattern3(pPattern, dwStart, dwStart + dwSize, dwOffset);
}
