...
namespace ImGui
{
    ...
    IMGUI_API void          Columns(int count = 1, const char* id = NULL, bool border = false);  // setup number of columns. use an identifier to distinguish multiple column sets. close with Columns(1).
