...
void __fastcall hkPaintTraverse(PVOID pPanels, int edx, unsigned int vguiPanel, bool forceRepaint, bool allowForce)
{
	...
	else if (FocusOverlayPanel == vguiPanel)
	{
		...
		{
			g_Render->Text(1, 1, Color(0, 255, 0, 255), g_Render->font.Watermark, "Project-xInfinity");
		}
		else if(g_Options.Misc.Watermark)
		{
			g_Render->Text(1, 1, Color(0, 255, 0, 255), g_Render->font.Watermark, "");
		}
