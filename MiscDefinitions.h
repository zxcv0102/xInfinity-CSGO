...
public:
	...
	matrix3x4_t_t(Vector xAxis, Vector yAxis, Vector zAxis, Vector vecOrigin)
	{
		m_flMatVal[0][0] = xAxis.x; m_flMatVal[0][1] = yAxis.x; m_flMatVal[0][2] = zAxis.x; m_flMatVal[0][3] = vecOrigin.x;
		m_flMatVal[1][0] = xAxis.y; m_flMatVal[1][1] = yAxis.y; m_flMatVal[1][2] = zAxis.y; m_flMatVal[1][3] = vecOrigin.y;
		m_flMatVal[2][0] = xAxis.z; m_flMatVal[2][1] = yAxis.z; m_flMatVal[2][2] = zAxis.z; m_flMatVal[2][3] = vecOrigin.z;
...
class __declspec(align(16)) matrix3x4_ta_t : public matrix3x4_t_t
{
public:
	matrix3x4_ta_t& operator=(const matrix3x4_t_t& src) { memcpy(Base(), src.Base(), sizeof(float) * 3 * 4); return *this; };
};
